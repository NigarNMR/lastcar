...
class ModelSettingStore extends Model {
  ...
  public function getTotalStoresByOrderProductStatusId($order_product_status_id) {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "setting WHERE `key` = 'config_order_product_status_id' AND `value` = '" . (int)$order_product_status_id . "' AND store_id != '0'");
