...
class ControllerLocalisationOrderStatus extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['order_status'])) {
			...
			$data['text_color'] = $this->model_localisation_order_status->getOrderStatusTextColor($this->request->get['order_status_id']);
		} else {
			...
			$data['bg_color'] = $this->model_localisation_order_status->getOrderStatusBgColor($this->request->get['order_status_id']);
		} else {
...
// проверка на буквенное значение
