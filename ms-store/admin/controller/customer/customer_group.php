...
class ControllerCustomerCustomerGroup extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_approval'] = $this->language->get('entry_approval');
                $data['entry_mark_up'] = $this->language->get('entry_mark_up');
		...
		if (isset($this->request->post['approval'])) {
			...
			$data['approval'] = '';
                ...
                if (isset($this->request->post['mark_up'])) {
			$data['mark_up'] = (int)$this->request->post['mark_up'];
		} elseif (!empty($customer_group_info)) {
			$data['mark_up'] = $customer_group_info['mark_up'];
		} else {
			$data['mark_up'] = '';
		}
