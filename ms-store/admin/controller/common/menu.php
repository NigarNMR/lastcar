...
class ControllerCommonMenu extends Controller {
	public function index() {
        ...
        $data['text_similarity'] = $this->language->get('text_similarity');
        $data['text_dictionary'] = $this->language->get('text_dictionary');
        $data['text_analogs'] = $this->language->get('text_analogs');
        $data['text_complaints'] = $this->language->get('text_complaints');
        $data['text_black_list'] = $this->language->get('text_black_list');
        $data['text_import'] = $this->language->get('text_import');
        $data['text_nochecked_brands'] = $this->language->get('text_nochecked_brands');
        $data['text_group_brands'] = $this->language->get('text_group_brands');
		...
		$data['text_order_product_status'] = $this->language->get('text_order_product_status');
		...
		$data['text_workflow'] = $this->language->get('text_workflow');
		$data['text_order_workflow'] = $this->language->get('text_order_workflow');
                              

		$data['workflow'] = $this->url->link('workflow/workflow', 'token=' . $this->session->data['token'], true);
		$data['order_workflow'] = $this->url->link('order_workflow/order_workflow', 'token=' . $this->session->data['token'], true);
        ...
        $data['crosses'] = $this->url->link('crosses/crosses', 'token=' . $this->session->data['token'], true);
        $data['similarity'] = $this->url->link('brands/similarity', 'token=' . $this->session->data['token'], true);
        $data['brands'] = $this->url->link('brands/GroupBrands', 'token=' . $this->session->data['token'], true);
        $data['complaints'] = $this->url->link('crosses/complaints', 'token=' . $this->session->data['token'], true);
        $data['group_brands'] = $this->url->link('brands/GroupBrands', 'token=' . $this->session->data['token'], true);
        $data['aliasDict'] = $this->url->link('brands/AliasDict', 'token=' . $this->session->data['token'], true);
        $data['nochecked_brands'] = $this->url->link('brands/brands', 'token=' . $this->session->data['token'], true);
        $data['black_list'] = $this->url->link('crosses/black_list', 'token=' . $this->session->data['token'], true);
        $data['import'] = $this->url->link('crosses/import', 'token=' . $this->session->data['token'], true);
		$data['order'] = $this->url->link('sale/order', 'token=' . $this->session->data['token'], true);
        $data['api'] = $this->url->link('api/api', 'token=' . $this->session->data['token'], true);
		$data['order_status'] = $this->url->link('localisation/order_status', 'token=' . $this->session->data['token'], true);
		$data['order_product_status'] = $this->url->link('localisation/order_product_status', 'token=' . $this->session->data['token'], true);
