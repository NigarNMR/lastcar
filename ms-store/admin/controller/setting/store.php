...
class ControllerSettingStore extends Controller {
	...
	public function getForm() {
		...
		$data['entry_telephone'] = $this->language->get('entry_slogan');
                $data['entry_slogan'] = $this->language->get('entry_telephone');
    ...
    if (isset($this->request->post['config_order_product_status_id'])) {
		...
		} elseif (isset($store_info['config_order_product_status_id'])) {
			$data['config_order_product_status_id'] = $store_info['config_order_product_status_id'];
		} else {
			$data['config_order_product_status_id'] = '';
		}
