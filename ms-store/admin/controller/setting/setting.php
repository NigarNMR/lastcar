...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
        ...
        $data['text_pinfo_banking'] = $this->language->get('text_pinfo_banking');
        $data['text_pinfo_cash'] = $this->language->get('text_pinfo_cash');

		$data['entry_name'] = $this->language->get('entry_name');
                $data['entry_slogan'] = $this->language->get('entry_slogan');
		...
		$data['entry_order_product_status'] = $this->language->get('entry_order_product_status');
        ...
        $data['entry_pinfo_org_name'] = $this->language->get('entry_pinfo_org_name');
        $data['entry_pinfo_taxpayer_id'] = $this->language->get('entry_pinfo_taxpayer_id');
        $data['entry_pinfo_taxpayer_id_desc'] = $this->language->get('entry_pinfo_taxpayer_id_desc');
        $data['entry_pinfo_paccount_id'] = $this->language->get('entry_pinfo_paccount_id');
        $data['entry_pinfo_bank_id'] = $this->language->get('entry_pinfo_bank_id');
        $data['entry_pinfo_bank_id_desc'] = $this->language->get('entry_pinfo_bank_id_desc');
        $data['entry_pinfo_bank_name'] = $this->language->get('entry_pinfo_bank_name');
        $data['entry_pinfo_contact_number'] = $this->language->get('entry_pinfo_contact_number');
        $data['entry_pinfo_contact_email'] = $this->language->get('entry_pinfo_contact_email');
        $data['entry_pinfo_contact_address'] = $this->language->get('entry_pinfo_contact_address');
        $data['entry_pinfo_timetable_days'] = $this->language->get('entry_pinfo_timetable_days');
        $data['entry_pinfo_timetable_weekdays'] = $this->language->get('entry_pinfo_timetable_weekdays');
        $data['entry_pinfo_timetable_weekends'] = $this->language->get('entry_pinfo_timetable_weekends');
        $data['entry_pinfo_timetable_monday'] = $this->language->get('entry_pinfo_timetable_monday');
        $data['entry_pinfo_timetable_tuesday'] = $this->language->get('entry_pinfo_timetable_tuesday');
        $data['entry_pinfo_timetable_wednesday'] = $this->language->get('entry_pinfo_timetable_wednesday');
        $data['entry_pinfo_timetable_thursday'] = $this->language->get('entry_pinfo_timetable_thursday');
        $data['entry_pinfo_timetable_friday'] = $this->language->get('entry_pinfo_timetable_friday');
        $data['entry_pinfo_timetable_saturday'] = $this->language->get('entry_pinfo_timetable_saturday');
        $data['entry_pinfo_timetable_sunday'] = $this->language->get('entry_pinfo_timetable_sunday');
        $data['entry_pinfo_timetable_from'] = $this->language->get('entry_pinfo_timetable_from');
        $data['entry_pinfo_timetable_to'] = $this->language->get('entry_pinfo_timetable_to');
		...
		$data['help_order_product_status'] = $this->language->get('help_order_product_status');
        ...
        $data['tab_pinfo'] = $this->language->get('tab_pinfo');
		...
		if (isset($this->error['telephone'])) {
			...
			$data['error_telephone'] = '';
                ...
                if (isset($this->error['slogan'])) {
			$data['error_slogan'] = $this->error['slogan'];
		} else {
			$data['error_slogan'] = '';
		}
    ...
    if (isset($this->request->post['config_order_product_status_id'])) {
			$data['config_order_product_status_id'] = $this->request->post['config_order_product_status_id'];
		} else {
			$data['config_order_product_status_id'] = $this->config->get('config_order_product_status_id');
		}
    ...
    $this->load->model('localisation/order_product_status');
		...
		$data['order_product_statuses'] = $this->model_localisation_order_product_status->getOrderProductStatuses();
        ...
        // Получение данных по пополнению баланса
        if (isset($this->request->post['config_pinfo_org-name'])) {
            $data['config_pinfo_org_name'] = $this->request->post['config_pinfo_org_name'];
        } else {
            $data['config_pinfo_org_name'] = $this->config->get('config_pinfo_org_name');
        }
        
        if (isset($this->request->post['config_pinfo_taxpayer_id'])) {
            $data['config_pinfo_taxpayer_id'] = $this->request->post['config_pinfo_taxpayer_id'];
        } else {
            $data['config_pinfo_taxpayer_id'] = $this->config->get('config_pinfo_taxpayer_id');
        }
        
        if (isset($this->request->post['config_pinfo_paccount_id'])) {
            $data['config_pinfo_paccount_id'] = $this->request->post['config_pinfo_paccount_id'];
        } else {
            $data['config_pinfo_paccount_id'] = $this->config->get('config_pinfo_paccount_id');
        }
        
        if (isset($this->request->post['config_pinfo_bank_id'])) {
            $data['config_pinfo_bank_id'] = $this->request->post['config_pinfo_bank_id'];
        } else {
            $data['config_pinfo_bank_id'] = $this->config->get('config_pinfo_bank_id');
        }
        
        if (isset($this->request->post['config_pinfo_bank_name'])) {
            $data['config_pinfo_bank_name'] = $this->request->post['config_pinfo_bank_name'];
        } else {
            $data['config_pinfo_bank_name'] = $this->config->get('config_pinfo_bank_name');
        }
        
        if (isset($this->request->post['config_pinfo_contact_number'])) {
            $data['config_pinfo_contact_number'] = $this->request->post['config_pinfo_contact_number'];
        } else {
            $data['config_pinfo_contact_number'] = $this->config->get('config_pinfo_contact_number');
        }
        
        if (isset($this->request->post['config_pinfo_contact_email'])) {
            $data['config_pinfo_contact_email'] = $this->request->post['config_pinfo_contact_email'];
        } else {
            $data['config_pinfo_contact_email'] = $this->config->get('config_pinfo_contact_email');
        }
        
        if (isset($this->request->post['config_pinfo_contact_address'])) {
            $data['config_pinfo_contact_address'] = $this->request->post['config_pinfo_contact_address'];
        } else {
            $data['config_pinfo_contact_address'] = $this->config->get('config_pinfo_contact_address');
        }
        
        if (isset($this->request->post['config_pinfo_timetable_days'])) {
            $data['config_pinfo_timetable_days'] = $this->request->post['config_pinfo_timetable_days'];
        } else {
            $data['config_pinfo_timetable_days'] = $this->config->get('config_pinfo_timetable_days');
        }
        
        $data['template_timetable_days'] = [//array('1','2','3','4','5','6','7');
            ['number' => '1', 'name' => $this->language->get('entry_pinfo_timetable_monday')],
            ['number' => '2', 'name' => $this->language->get('entry_pinfo_timetable_tuesday')],
            ['number' => '3', 'name' => $this->language->get('entry_pinfo_timetable_wednesday')],
            ['number' => '4', 'name' => $this->language->get('entry_pinfo_timetable_thursday')],
            ['number' => '5', 'name' => $this->language->get('entry_pinfo_timetable_friday')],
            ['number' => '6', 'name' => $this->language->get('entry_pinfo_timetable_saturday')],
            ['number' => '7', 'name' => $this->language->get('entry_pinfo_timetable_sunday')],
        ];
        if (isset($this->request->post['config_pinfo_timetable_weekdays'])) {
            $data['config_pinfo_timetable_weekdays'] = $this->request->post['config_pinfo_timetable_weekdays'];
        } else {
            $data['config_pinfo_timetable_weekdays'] = $this->config->get('config_pinfo_timetable_weekdays');
        }
        
        if (isset($this->request->post['config_pinfo_timetable_weekends'])) {
            $data['config_pinfo_timetable_weekends'] = $this->request->post['config_pinfo_timetable_weekends'];
        } else {
            $data['config_pinfo_timetable_weekends'] = $this->config->get('config_pinfo_timetable_weekends');
        }
        
        // Конец блока получения данных по пополнению баланса
