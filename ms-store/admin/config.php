...
/*
  // HTTP
  define('HTTP_SERVER', 'http://eijen.localhost/admin/');
  define('HTTP_CATALOG', 'http://eijen.localhost/');

  // HTTPS
  define('HTTPS_SERVER', 'http://eijen.localhost/admin/');
  define('HTTPS_CATALOG', 'http://eijen.localhost/');

  // DIR
  define('DIR_APPLICATION', 'C:/OpenServer/domains/eijen.localhost/admin/');
  define('DIR_SYSTEM', 'C:/OpenServer/domains/eijen.localhost/system/');
  define('DIR_IMAGE', 'C:/OpenServer/domains/eijen.localhost/image/');
  define('DIR_LANGUAGE', 'C:/OpenServer/domains/eijen.localhost/admin/language/');
  define('DIR_TEMPLATE', 'C:/OpenServer/domains/eijen.localhost/admin/view/template/');
  ...
  define('DIR_CATALOG', 'C:/OpenServer/domains/eijen.localhost/catalog/');
...
if (is_file($local_config_tdm = dirname(dirname(__FILE__)) . DIRECTORY_SEPARATOR . 'autoparts' . DIRECTORY_SEPARATOR . 'config.local.php')) {  
