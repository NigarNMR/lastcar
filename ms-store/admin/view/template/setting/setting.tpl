      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-pinfo" data-toggle="tab"><?php echo $tab_pinfo; ?></a></li>
          </ul>
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                <label class="col-sm-2 control-label" for="input-slogan"><?php echo $entry_slogan; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_slogan" value="<?php echo $config_slogan; ?>" placeholder="<?php echo $entry_slogan; ?>" id="input-slogan" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
            ...
            <div class="tab-pane" id="tab-option">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-order-product-status"><span data-toggle="tooltip" title="<?php echo $help_order_product_status; ?>"><?php echo $entry_order_product_status; ?></span></label>
                  <div class="col-sm-10">
                    <select name="config_order_product_status_id" id="input-order-product-status" class="form-control">
                      <?php foreach ($order_product_statuses as $order_product_status) { ?>
                      <?php if ($order_product_status['order_product_status_id'] == $config_order_product_status_id) { ?>
                      <option value="<?php echo $order_product_status['order_product_status_id']; ?>" selected="selected"><?php echo $order_product_status['name']; ?></option>
                      <?php } else { ?>
                      <option value="<?php echo $order_product_status['order_product_status_id']; ?>"><?php echo $order_product_status['name']; ?></option>
                      <?php } ?>
                      <?php } ?>
                    </select>
                  </div>
            ...
            <div class="tab-pane" id="tab-pinfo">
              <fieldset>
                  <legend><?php echo $text_pinfo_banking; ?></legend>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-pinfo-org-name"><?php echo $entry_pinfo_org_name; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="config_pinfo_org_name" value="<?php echo $config_pinfo_org_name; ?>" placeholder="<?php echo $entry_pinfo_org_name; ?>" id="input-pinfo-org-name" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-pinfo-taxpayer-number"><?php echo $entry_pinfo_taxpayer_id; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="config_pinfo_taxpayer_id" value="<?php echo $config_pinfo_taxpayer_id; ?>" placeholder="<?php echo $entry_pinfo_taxpayer_id; ?>" id="input-pinfo-taxpayer-number" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-pinfo-paccount-number"><?php echo $entry_pinfo_paccount_id; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="config_pinfo_paccount_id" value="<?php echo $config_pinfo_paccount_id; ?>" placeholder="<?php echo $entry_pinfo_paccount_id; ?>" id="input-pinfo-paccount-number" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-pinfo-bank-id"><?php echo $entry_pinfo_bank_id; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="config_pinfo_bank_id" value="<?php echo $config_pinfo_bank_id; ?>" placeholder="<?php echo $entry_pinfo_bank_id; ?>" id="input-pinfo-bank-id" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-pinfo-bank-name"><?php echo $entry_pinfo_bank_name; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="config_pinfo_bank_name" value="<?php echo $config_pinfo_bank_name; ?>" placeholder="<?php echo $entry_pinfo_bank_name; ?>" id="input-pinfo-bank-name" class="form-control" />
                    </div>
                  </div>
              </fieldset>
              <fieldset>
                <legend><?php echo $text_pinfo_cash; ?></legend>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-pinfo-contact-number"><?php echo $entry_pinfo_contact_number; ?></label>
                  <div class="col-sm-10">
                    <textarea name="config_pinfo_contact_number" rows="5" placeholder="<?php echo $entry_pinfo_contact_number; ?>" id="input-pinfo-contact-number" class="form-control"><?php echo $config_pinfo_contact_number; ?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-pinfo-contact-email"><?php echo $entry_pinfo_contact_email; ?></label>
                  <div class="col-sm-10">
                    <textarea name="config_pinfo_contact_email" rows="5" placeholder="<?php echo $entry_pinfo_contact_email; ?>" id="input-pinfo-contact-email" class="form-control"><?php echo $config_pinfo_contact_email; ?></textarea>
                  </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-pinfo-contact-address"><?php echo $entry_pinfo_contact_address; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="config_pinfo_contact_address" value="<?php echo $config_pinfo_contact_address; ?>" placeholder="<?php echo $entry_pinfo_contact_address; ?>" id="input-pinfo-contact-address" class="form-control" />
                    </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-pinfo-timetable-days"><?php echo $entry_pinfo_timetable_days; ?></label>
                  <div class="col-sm-10">
                    <div class="well well-sm">
                      <?php foreach ($template_timetable_days as $template_timetable_day) { ?>
                      <div class="checkbox">
                        <label>
                          <?php if (is_array($config_pinfo_timetable_days) && (in_array($template_timetable_day['number'], $config_pinfo_timetable_days))) { ?>
                          <input type="checkbox" name="config_pinfo_timetable_days[]" value="<?php echo $template_timetable_day['number']; ?>" checked="checked" />
                          <?php echo $template_timetable_day['name']; ?>
                          <?php } else { ?>
                          <input type="checkbox" name="config_pinfo_timetable_days[]" value="<?php echo $template_timetable_day['number']; ?>" />
                          <?php echo $template_timetable_day['name']; ?>
                          <?php } ?>
                        </label>
                      </div>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-pinfo-timetable-weekdays"><?php echo $entry_pinfo_timetable_weekdays; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="config_pinfo_timetable_weekdays" value="<?php echo $config_pinfo_timetable_weekdays; ?>" placeholder="<?php echo $entry_pinfo_timetable_weekdays; ?>" id="input-pinfo-timetable-weekdays" class="form-control" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-pinfo-timetable-weekends"><?php echo $entry_pinfo_timetable_weekends; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="config_pinfo_timetable_weekends" value="<?php echo $config_pinfo_timetable_weekends; ?>" placeholder="<?php echo $entry_pinfo_timetable_weekends; ?>" id="input-pinfo-timetable-weekends" class="form-control" />
                    </div>
                </div>
              </fieldset>
            </div>
