...
<html dir="<?php echo $direction; ?>" lang="<?php echo $lang; ?>">
    <head>
        ...
        <script src="view/javascript/jquery/daterangepicker/moment.js" type="text/javascript"></script>
        <script src="view/javascript/jquery/datetimepicker/bootstrap-datetimepicker.min.js" type="text/javascript"></script>
        <script src="view/javascript/jquery/daterangepicker/daterangepicker.js" type="text/javascript"></script>
        <link href="view/javascript/jquery/datetimepicker/bootstrap-datetimepicker.min.css" type="text/css" rel="stylesheet" media="screen" />
        <link href="view/javascript/jquery/daterangepicker/daterangepicker.css" type="text/css" rel="stylesheet" media="screen" />
        <link type="text/css" href="view/stylesheet/stylesheet.css" rel="stylesheet" media="screen" />
        <link type="text/css" href="view/stylesheet/pick-a-color-1.2.3.min.css" rel="stylesheet" media="screen" />
