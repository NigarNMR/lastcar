<ul id="menu">
  ...
  <li id="sale"><a class="parent"><i class="fa fa-adjust fa-fw"></i> <span><?php echo $text_sale; ?></span></a>
    <ul>
      <li><a href="<?php echo $brands; ?>"><?php echo $text_group_brands; ?></a></li>
      <li><a href="<?php echo $nochecked_brands; ?>"><?php echo $text_nochecked_brands; ?></a></li>
      <li><a href="<?php echo $aliasDict; ?>"><?php echo $text_dictionary; ?></a></li>
      <li><a href="<?php echo $similarity; ?>"><?php echo $text_similarity; ?></a></li>
    </ul>
  </li>

  <li id="sale"><a class="parent"><i class="fa fa-adjust fa-fw"></i> <span><?php echo $text_sale; ?></span></a>
    <ul>
      <li><a href="<?php echo $crosses; ?>"><?php echo $text_analogs; ?></a></li>
      <li><a href="<?php echo $complaints; ?>"><?php echo $text_complaints; ?></a></li>
      <li><a href="<?php echo $black_list; ?>"><?php echo $text_black_list; ?></a></li>
      <li><a href="<?php echo $import; ?>"><?php echo $text_import; ?></a>
    </ul>
  </li>
    ...
    <ul>
      ...
      <li><a class="parent"><?php echo $text_localisation; ?></a>
        <ul>
          ...
          <li><a href="<?php echo $order_product_status; ?>"><?php echo $text_order_product_status; ?></a></li>
      ...
      <li><a href="<?php echo $workflow; ?>"><?php echo $text_workflow; ?></a></li> <!--управление статусами товара -->
      <li><a href="<?php echo $order_workflow; ?>"><?php echo $text_order_workflow; ?></a></li> <!--управление статусами заказа -->
    </ul>
  </li>
