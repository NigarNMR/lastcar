    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <form method="post" action="" enctype="multipart/form-data" target="_blank" id="form-order">
          ...
          <li><a href="<?php echo  $orders_position;?>">Список заказов по позициям</a></li>
        </ul>
        ...
        <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                          ...
                          <tbody>
                              <!-- страница с выводом списка заказов-->
                            <?php if ($orders) { ?>
                            ...
                            <tr>
                              ...
                              <!-- окрашивание статуса работает-->
                              <td class="text-left" style="background-color: <?php echo '#' . $order['bg_color']; ?>; color: <?php echo '#' . $order['text_color']; ?> ;"><?php echo $order['order_status']; ?></td>
