                ...
                <div class="col-sm-10">
                  <div class="tab-content">
                    <div class="tab-pane active" id="tab-customer">
                      ...
                      <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-balance-limit"><?php echo $entry_limit; ?></label>
                        <div class="col-sm-10">
                          <input type="text" name="limit" value="<?php echo $limit; ?>" placeholder="<?php echo $entry_limit; ?>" id="input-balance-limit" class="form-control" />
                          <?php if ($error_limit) { ?>
...
$('#transaction').delegate('.page-tab-opt a', 'click', function(e) {
	e.preventDefault();
	$('#transaction').load(this.href);
});

$('#transaction').delegate('.page-limit-opt a', 'click', function(e) {
	e.preventDefault();
	$('#transaction').load(this.href);
});

$('#transaction').delegate('#transaction-export a', 'click', function(e) {
	e.preventDefault();
