    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-customer-group" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-mark_up"><?php echo "$entry_mark_up (%)"; ?></label>
            <div class="col-sm-10">
              <input type="text" name="mark_up" value="<?php echo $mark_up; ?>" placeholder="<?php echo $entry_mark_up; ?>" id="input-mark_up" class="form-control" />
            </div>
          </div>
        </form>
      </div>
