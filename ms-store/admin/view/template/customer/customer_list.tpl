  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <a href="javascript:void(0)" id="btn-refresh" data-toggle="tooltip" title="<?php echo $button_refresh; ?>" class="btn btn-primary"><i class="fa fa-refresh"></i></a>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php echo $text_balance; ?></td>
