...
class ControllerCommonHeader extends Controller {
	public function index() {
		// Analytics
                ...
                $store_info=$this->model_extension_extension->getSetting('config');
		...
		$data['text_logged'] = sprintf($this->language->get('text_logged'), $this->url->link('account/account', '', true), $this->customer->getFirstName(), $this->customer->getLastName(), $this->url->link('account/logout', '', true));
		...
		$data['register'] = $this->url->link('account/simpleregister', '', true);
		...
		$data['contact'] = $this->url->link('account/message');
