...
class ControllerCheckoutConfirm extends Controller {
    ...
    public function index() {
        ...
        if ((!$this->cart->hasProducts(1) && empty($this->session->data['vouchers'])) || (!$this->cart->hasStock(1) && !$this->config->get('config_stock_checkout'))) {
...
////////////////////////////////////////////////////////////////////////////////////////
            ...
            if (isset($this->request->cookie['tracking'])) {
                ...
                $subtotal = $this->cart->getSubTotal(1);
            ...
            $data['products'] = array(); // определили переменную как массив, задаем ей значения
...
// нет system, вот он. сюда заносим для вывода из "бд" 
...
/////////////////здесь вытаскиваем данные из БД в переменную $data//////////////                    
                    $data['products'][] = array(
                        'cart_id' => $product['cart_id'],
                        'product_id' => $product['product_id'],
                        'name' => $product['name'],
