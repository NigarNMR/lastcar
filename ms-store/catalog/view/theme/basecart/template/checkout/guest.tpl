...
$('#collapse-payment-address input[name=\'customer_group_id\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=checkout/simplecheckout/customfield&customer_group_id=' + this.value,
		dataType: 'json',
...
$('#collapse-payment-address select[name=\'country_id\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=checkout/simplecheckout/country&country_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
