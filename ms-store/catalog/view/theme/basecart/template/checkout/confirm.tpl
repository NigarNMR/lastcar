    ...
    <table class="table table-bordered table-hover">
        <thead>
            <tr>
                ...
                <td class="text-right"><?php echo $column_day; ?></td>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-left"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
                    ...
                    <?php } ?></td>
                <td class="text-right"><?php if (isset($product['day'])){ echo $product['day']; }?></td>
                <td class="text-center"><?php echo $product['quantity']; ?></td> 
                <td class="text-right"><?php echo $product['comment']; ?></td>
