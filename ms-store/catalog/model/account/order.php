...
class ModelAccountOrder extends Model {
	...
	public function getOrders($start = 0, $limit = 20) {
		...
		$query = $this->db->query("SELECT o.order_id, o.firstname, o.lastname, os.bg_color as bg_color, os.text_color as text_color, os.name as status, o.date_added, o.total, o.currency_code, o.currency_value FROM `" . DB_PREFIX . "order` o LEFT JOIN " . DB_PREFIX . "order_status os ON (o.order_status_id = os.order_status_id) WHERE o.customer_id = '" . (int)$this->customer->getId() . "' AND o.order_status_id > '0' AND o.store_id = '" . (int)$this->config->get('config_store_id') . "' AND os.language_id = '" . (int)$this->config->get('config_language_id') . "' ORDER BY o.order_id DESC LIMIT " . (int)$start . "," . (int)$limit);
  ...
  public function getOrdersProducts($start = 0, $limit = 20) {
		...
		//$query = $this->db->query("SELECT op.*, ops.name as ops_name, o.order_id, o.firstname, o.lastname, os.name as status, o.date_added, o.total, o.currency_code, o.currency_value FROM `" . DB_PREFIX . "order_product` op INNER JOIN " . DB_PREFIX . "order_product_status ops ON op.order_product_status_id = ops.order_product_status_id INNER JOIN `" . DB_PREFIX . "order` o ON op.order_id = o.order_id LEFT JOIN " . DB_PREFIX . "order_status os ON (o.order_status_id = os.order_status_id) WHERE o.customer_id = '" . (int)$this->customer->getId() . "' AND o.order_status_id > '0' AND o.store_id = '" . (int)$this->config->get('config_store_id') . "' AND os.language_id = '" . (int)$this->config->get('config_language_id') . "'AND ops.language_id = '" . (int) $this->config->get('config_language_id')."' ORDER BY o.order_id DESC LIMIT " . (int)$start . "," . (int)$limit);
    $query = $this->db->query("SELECT op.*, o.order_id, o.firstname, o.lastname, o.order_status_id, os.name as status_name, o.date_added, o.total, o.currency_code, o.currency_value  FROM " . DB_PREFIX . "order_product op INNER JOIN `" . DB_PREFIX . "order` o ON op.order_id = o.order_id LEFT JOIN " . DB_PREFIX . "order_status os ON (o.order_status_id = os.order_status_id) WHERE o.customer_id = '" . (int)$this->customer->getId() . "' AND o.order_status_id > '0' AND o.store_id = '" . (int)$this->config->get('config_store_id') . "' AND os.language_id = '" . (int)$this->config->get('config_language_id') . "' AND op.fragmentation_status = '0' ORDER BY o.order_id DESC LIMIT " . (int)$start . "," . (int)$limit);
    /*
    $sql = "SELECT op.*, o.order_id, o.firstname, o.lastname, o.order_status_id, os.name as status_name, o.date_added, o.total, o.currency_code, o.currency_value  FROM " . DB_PREFIX . "order_product op INNER JOIN `" . DB_PREFIX . "order` o ON op.order_id = o.order_id LEFT JOIN " . DB_PREFIX . "order_status os ON (o.order_status_id = os.order_status_id) WHERE o.customer_id = '" . (int)$this->customer->getId() . "' AND o.order_status_id > '0' AND o.store_id = '" . (int)$this->config->get('config_store_id') . "' AND os.language_id = '" . (int)$this->config->get('config_language_id') . "' ORDER BY o.order_id DESC LIMIT " . (int)$start . "," . (int)$limit;
    echo '<pre>';
    var_dump($sql);
    echo '</pre>';*/
    ...
    $order_product_query = $this->db->query("SELECT op.*, ops.bg_color as bg_color, ops.text_color as text_color, ops.name as ops_name, o.date_added, o.currency_code, o.currency_value  FROM " . DB_PREFIX . "order_product op INNER JOIN " . DB_PREFIX . "order_product_status ops ON op.order_product_status_id = ops.order_product_status_id INNER JOIN " . DB_PREFIX . "order o ON op.order_id = o.order_id WHERE op.order_id = '" . (int)$order_id . "' AND op.order_product_id = '" . (int) $order_product_id . "' AND ops.language_id = '" . (int) $this->config->get('config_language_id') . "'");    
    /*echo '<br>'."SELECT op.*, ops.bg_color as bg_color, ops.text_color as text_color, ops.name as ops_name, o.date_added, o.currency_code, o.currency_value  FROM " . DB_PREFIX . "order_product op INNER JOIN " . DB_PREFIX . "order_product_status ops ON op.order_product_status_id = ops.order_product_status_id INNER JOIN " . DB_PREFIX . "order o ON op.order_id = o.order_id WHERE op.order_id = '" . (int)$order_id . "' AND op.order_product_id = '" . (int) $order_product_id . "' AND ops.language_id = '" . (int) $this->config->get('config_language_id') . "'" . '<br>';*/
    ...
    if ($order_product_query->num_rows) {
      ...
      return array(
          ...
          'date_added' => $order_product_query->row['date_added'],
          ...
          'order_product_parent_id' => intval($order_product_query->row['order_product_parent_id']),
      );
    }
    else {
      return;
    ...
    //$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "order_product WHERE order_id = '" . (int)$order_id . "'");
    //@note добавил выборку статуса товара в заказе
    $query = $this->db->query("SELECT op.*, ops.name as ops_name  FROM " . DB_PREFIX . "order_product op INNER JOIN " . DB_PREFIX . "order_product_status ops ON op.order_product_status_id = ops.order_product_status_id WHERE op.order_id = '" . (int) $order_id . "' AND ops.language_id = '" . (int) $this->config->get('config_language_id') . "'");    
		return $query->rows;
	}
    ...
    $s = "SELECT * FROM " . DB_PREFIX . "order_option WHERE order_id = '" . (int)$order_id . "' AND order_product_id = '" . (int)$order_product_id . "'";    
		return $query->rows;
	}
  ...
  public function getTotalOrderProductHistories($order_product_id) {
	...
	public function getOrderHistories($order_id) {
		$query = $this->db->query("SELECT date_added, os.bg_color as bg_color, os.text_color as text_color, os.name AS status, oh.comment, oh.notify FROM " . DB_PREFIX . "order_history oh LEFT JOIN " . DB_PREFIX . "order_status os ON oh.order_status_id = os.order_status_id WHERE oh.order_id = '" . (int)$order_id . "' AND os.language_id = '" . (int)$this->config->get('config_language_id') . "' ORDER BY oh.date_added");
