...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июл 11 2016 г., 08:02
...
--
-- Очистить таблицу перед добавлением данных `oc_affiliate_activity`
--

TRUNCATE TABLE `oc_affiliate_activity`;
--
-- Очистить таблицу перед добавлением данных `oc_affiliate_login`
--
...
--
-- Очистить таблицу перед добавлением данных `oc_api`
--
...
(1, 'Default', '', 1, '2016-07-09 16:37:35', '2016-07-09 16:37:35');

--
-- Очистить таблицу перед добавлением данных `oc_api_ip`
--

TRUNCATE TABLE `oc_api_ip`;
--
-- Очистить таблицу перед добавлением данных `oc_api_session`
--
...
--
-- Очистить таблицу перед добавлением данных `oc_cart`
--
...
(11, 0, 'n85p2ep8u0nr0g51pjhofqm0l7', 50, 0, '{"tecdoc":"Y","product_id":"914942503","key":"914942503","price":"1380.00","quantity":"2","stock":"2","name":"\\u041a\\u0430\\u0442\\u0443\\u0448\\u043a\\u0430 \\u0437\\u0430\\u0436\\u0438\\u0433\\u0430\\u043d\\u0438\\u044f","image":"http:\\/\\/77.120.224.229\\/images\\/61\\/1624698.jpg","brand":"BMW","product_url":"\\/autoparts\\/search\\/12137559842\\/BMW","day":"0","article":"12137559842","minimum":1,"weight":"","weight_prefix":"","weight_class_id":2,"points":"","points_prefix":"\\u0428\\u0442..","option":[{"name":"\\u0410\\u0440\\u0442\\u0438\\u043a\\u0443\\u043b","option_value":"12137559842","value":"12137559842","type":"text"},{"name":"\\u041f\\u043e\\u0441\\u0442\\u0430\\u0432\\u0449\\u0438\\u043a","option_value":"Autopuls","value":"Autopuls","type":"text"},{"name":"\\u0421\\u0440\\u043e\\u043a \\u043f\\u043e\\u0441\\u0442\\u0430\\u0432\\u043a\\u0438 (\\u0434\\u043d\\u0435\\u0439)","option_value":"0","value":"0","type":"text"},{"name":"\\u041d\\u0430\\u043b\\u0438\\u0447\\u0438\\u0435","option_value":"2","value":"2","type":"text"},{"name":"Price","option_value":"1380.00 RUB","value":"1380.00 RUB","type":"text"},{"name":"Date","option_value":"20.6.16","value":"20.6.16","type":"text"},{"name":"Code","option_value":"avp","value":"avp","type":"text"}]}', 2, '2016-07-10 17:59:02');

--
-- Очистить таблицу перед добавлением данных `oc_cart_check`
--

TRUNCATE TABLE `oc_cart_check`;
--
-- Дамп данных таблицы `oc_cart_check`
--

INSERT INTO `oc_cart_check` (`cart_id`, `checkbox`) VALUES
(8, 0),
(9, 0),
(10, 0),
(11, 0);
...
--
-- Очистить таблицу перед добавлением данных `oc_cart_comment`
--

TRUNCATE TABLE `oc_cart_comment`;
--
-- Дамп данных таблицы `oc_cart_comment`
--

INSERT INTO `oc_cart_comment` (`cart_id`, `comment`) VALUES
(10, '');
...
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.77219999, 1, '2016-07-10 12:31:31'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2016-07-10 12:32:04'),
(3, 'Euro', 'EUR', '', '€', '2', 0.90439999, 1, '2016-07-10 12:31:31'),
(4, 'Рубль', 'RUB', '', ' р.', '2', 1.00000000, 1, '2016-07-10 17:01:10');
...
--
-- Очистить таблицу перед добавлением данных `oc_customer_activity`
--
...
--
-- Очистить таблицу перед добавлением данных `oc_customer_login`
--
...
--
-- Очистить таблицу перед добавлением данных `oc_customer_wishlist`
--
...
--
-- Очистить таблицу перед добавлением данных `oc_custom_field_customer_group`
--
...
--
-- Очистить таблицу перед добавлением данных `oc_event`
--
...
--
-- Очистить таблицу перед добавлением данных `oc_layout_module`
--
...
--
-- Очистить таблицу перед добавлением данных `oc_location`
--
...
--
-- Очистить таблицу перед добавлением данных `oc_marketing`
--

TRUNCATE TABLE `oc_marketing`;
--
-- Очистить таблицу перед добавлением данных `oc_modification`
--

TRUNCATE TABLE `oc_modification`;
--
-- Очистить таблицу перед добавлением данных `oc_module`
--
...
(1, 0, 'INV-2013-00', 0, 'Your Store', 'http://eijen.localhost/', 0, 1, 'df', 'd', 'df@sdf.ty', '34534534', '', '[]', 'df', 'd', '', 'dfdf', '', 'df', '33', 'United Kingdom', 222, 'Anglesey', 3515, '', '[]', 'Cash On Delivery', 'cod', 'df', 'd', '', 'dfdf', '', 'df', '33', 'United Kingdom', 222, 'Anglesey', 3515, '', '[]', 'Flat Shipping Rate', 'flat.flat', '', '131.2000', 0, 0, '0.0000', 0, '', 1, 2, 'USD', '1.00000000', '::1', '', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.103 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2016-07-09 17:17:26', '2016-07-09 17:17:26'),
(2, 0, 'INV-2013-00', 0, 'AvtoBear', 'http://eijen.localhost/', 0, 1, 'df', 'd', 'df@sdf.ty', '34534534', '', '[]', 'df', 'd', '', 'dfdf', '', 'df', '33', 'United Kingdom', 222, 'Anglesey', 3515, '', '[]', 'Оплата при доставке', 'cod', 'df', 'd', '', 'dfdf', '', 'df', '33', 'United Kingdom', 222, 'Anglesey', 3515, '', '[]', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '6664.2500', 0, 0, '0.0000', 0, '', 2, 4, 'RUB', '1.00000000', '::1', '', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.103 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2016-07-10 16:58:43', '2016-07-10 16:58:43'),
(3, 0, 'INV-2013-00', 0, 'AvtoBear', 'http://eijen.localhost/', 0, 1, 'df', 'd', 'df@sdf.ty', '34534534', '', '[]', 'df', 'd', '', 'dfdf', '', 'df', '33', 'United Kingdom', 222, 'Anglesey', 3515, '', '[]', 'Оплата при доставке', 'cod', 'df', 'd', '', 'dfdf', '', 'df', '33', 'United Kingdom', 222, 'Anglesey', 3515, '', '[]', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '6664.2500', 0, 0, '0.0000', 0, '', 2, 4, 'RUB', '1.00000000', '::1', '', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.103 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2016-07-10 16:59:40', '2016-07-10 16:59:40');

--
-- Очистить таблицу перед добавлением данных `oc_order_custom_field`
--
...
(1, 2, 2, 0, 0, 'Артикул', '8MY376743451', 'text'),
(2, 2, 2, 0, 0, 'Поставщик', 'Autopuls', 'text'),
(3, 2, 2, 0, 0, 'Срок поставки (дней)', '0', 'text'),
(4, 2, 2, 0, 0, 'Наличие', '2', 'text'),
(5, 2, 2, 0, 0, 'Price', '920.00 RUB', 'text'),
(6, 2, 2, 0, 0, 'Date', '20.6.16', 'text'),
(7, 2, 2, 0, 0, 'Code', 'avp', 'text'),
(8, 2, 3, 0, 0, 'Артикул', '17111742231', 'text'),
(9, 2, 3, 0, 0, 'Поставщик', 'Autopuls', 'text'),
(10, 2, 3, 0, 0, 'Срок поставки (дней)', '0', 'text'),
(11, 2, 3, 0, 0, 'Наличие', '3', 'text'),
(12, 2, 3, 0, 0, 'Price', '1380.00 RUB', 'text'),
(13, 2, 3, 0, 0, 'Date', '20.6.16', 'text'),
(14, 2, 3, 0, 0, 'Code', 'avp', 'text'),
(15, 2, 4, 0, 0, 'Артикул', '11151726339', 'text'),
(16, 2, 4, 0, 0, 'Поставщик', 'Autopuls', 'text'),
(17, 2, 4, 0, 0, 'Срок поставки (дней)', '0', 'text'),
(18, 2, 4, 0, 0, 'Наличие', '5', 'text'),
(19, 2, 4, 0, 0, 'Price', '74.75 RUB', 'text'),
(20, 2, 4, 0, 0, 'Date', '20.6.16', 'text'),
(21, 2, 4, 0, 0, 'Code', 'avp', 'text');
...
(1, 1, 40, 'iPhone', 'product 11', 1, '101.0000', '101.0000', '22.2000', 0),
(2, 2, 634480208, 'Крышка радиатора', 'Hella', 4, '920.0000', '3680.0000', '0.0000', 0),
(3, 2, 113937244, 'Крышка', 'BMW', 2, '1380.0000', '2760.0000', '0.0000', 0),
(4, 2, 653278018, 'Хомут', 'BMW', 3, '74.7500', '224.2500', '0.0000', 0),
(5, 3, 634480208, 'Крышка радиатора', 'Hella', 4, '920.0000', '6664.2500', '0.0000', 0),
(6, 3, 653278018, 'Хомут', 'BMW', 3, '74.7500', '6664.2500', '0.0000', 0);
...
(4, 1, 'tax', 'VAT (20%)', '21.2000', 5),
(5, 1, 'total', 'Total', '131.2000', 9),
(6, 2, 'sub_total', 'Сумма', '6664.2500', 1),
(7, 2, 'total', 'Итого', '6664.2500', 9),
(8, 3, 'sub_total', 'Сумма', '6664.2500', 1),
(9, 3, 'total', 'Итого', '6664.2500', 9);
...
--
-- Очистить таблицу перед добавлением данных `oc_recurring`
--

TRUNCATE TABLE `oc_recurring`;
--
-- Очистить таблицу перед добавлением данных `oc_recurring_description`
--
...
(660, 0, 'config', 'config_checkout_guest', '1', 0),
(661, 0, 'config', 'config_checkout_id', '5', 0),
(662, 0, 'config', 'config_order_status_id', '1', 0),
(663, 0, 'config', 'config_processing_status', '["5","1","2","12","3"]', 1),
(664, 0, 'config', 'config_complete_status', '["5","3"]', 1),
(665, 0, 'config', 'config_fraud_status_id', '7', 0),
(666, 0, 'config', 'config_order_mail', '0', 0),
(667, 0, 'config', 'config_api_id', '1', 0),
(668, 0, 'config', 'config_stock_display', '0', 0),
(669, 0, 'config', 'config_stock_warning', '0', 0),
(670, 0, 'config', 'config_stock_checkout', '0', 0),
(671, 0, 'config', 'config_affiliate_approval', '0', 0),
(672, 0, 'config', 'config_affiliate_auto', '0', 0),
(673, 0, 'config', 'config_affiliate_commission', '5', 0),
(674, 0, 'config', 'config_affiliate_id', '4', 0),
(675, 0, 'config', 'config_affiliate_mail', '0', 0),
(676, 0, 'config', 'config_return_id', '0', 0),
(677, 0, 'config', 'config_return_status_id', '2', 0),
(678, 0, 'config', 'config_captcha', '', 0),
(679, 0, 'config', 'config_captcha_page', '["review","return","contact"]', 1),
(680, 0, 'config', 'config_logo', 'catalog/logo.png', 0),
(681, 0, 'config', 'config_icon', 'catalog/cart.png', 0),
(682, 0, 'config', 'config_ftp_hostname', 'eijen.localhost', 0),
(683, 0, 'config', 'config_ftp_port', '21', 0),
(684, 0, 'config', 'config_ftp_username', '', 0),
(685, 0, 'config', 'config_ftp_password', '', 0),
(686, 0, 'config', 'config_ftp_root', '', 0),
(687, 0, 'config', 'config_ftp_status', '0', 0),
(688, 0, 'config', 'config_mail_protocol', 'mail', 0),
(689, 0, 'config', 'config_mail_parameter', '', 0),
(690, 0, 'config', 'config_mail_smtp_hostname', '', 0),
(691, 0, 'config', 'config_mail_smtp_username', '', 0),
(692, 0, 'config', 'config_mail_smtp_password', '', 0),
(693, 0, 'config', 'config_mail_smtp_port', '25', 0),
(694, 0, 'config', 'config_mail_smtp_timeout', '5', 0),
(695, 0, 'config', 'config_mail_alert', '', 0),
(696, 0, 'config', 'config_maintenance', '0', 0),
(697, 0, 'config', 'config_seo_url', '0', 0),
(698, 0, 'config', 'config_robots', 'abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai''hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg', 0),
(103, 0, 'free_checkout', 'free_checkout_status', '1', 0),
(104, 0, 'free_checkout', 'free_checkout_order_status_id', '1', 0),
(707, 0, 'config', 'config_error_display', '1', 0),
(704, 0, 'config', 'config_file_max_size', '300000', 0),
(705, 0, 'config', 'config_file_ext_allowed', 'zip\r\ntxt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc', 0),
(706, 0, 'config', 'config_file_mime_allowed', 'text/plain\r\nimage/png\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/tiff\r\nimage/svg+xml\r\napplication/zip\r\n&quot;application/zip&quot;\r\napplication/x-zip\r\n&quot;application/x-zip&quot;\r\napplication/x-zip-compressed\r\n&quot;application/x-zip-compressed&quot;\r\napplication/rar\r\n&quot;application/rar&quot;\r\napplication/x-rar\r\n&quot;application/x-rar&quot;\r\napplication/x-rar-compressed\r\n&quot;application/x-rar-compressed&quot;\r\napplication/octet-stream\r\n&quot;application/octet-stream&quot;\r\naudio/mpeg\r\nvideo/quicktime\r\napplication/pdf', 0),
(703, 0, 'config', 'config_encryption', '', 0),
(702, 0, 'config', 'config_shared', '0', 0),
(701, 0, 'config', 'config_password', '1', 0),
(700, 0, 'config', 'config_secure', '0', 0),
(699, 0, 'config', 'config_compression', '0', 0),
(338, 0, 'theme_default', 'theme_default_image_cart_width', '47', 0),
(337, 0, 'theme_default', 'theme_default_image_wishlist_height', '47', 0),
(336, 0, 'theme_default', 'theme_default_image_wishlist_width', '47', 0),
(335, 0, 'theme_default', 'theme_default_image_compare_height', '90', 0),
(334, 0, 'theme_default', 'theme_default_image_compare_width', '90', 0),
(333, 0, 'theme_default', 'theme_default_image_related_height', '200', 0),
(332, 0, 'theme_default', 'theme_default_image_related_width', '200', 0),
(331, 0, 'theme_default', 'theme_default_image_additional_height', '74', 0),
(330, 0, 'theme_default', 'theme_default_image_additional_width', '74', 0),
(329, 0, 'theme_default', 'theme_default_image_product_height', '228', 0),
(328, 0, 'theme_default', 'theme_default_image_product_width', '228', 0),
(327, 0, 'theme_default', 'theme_default_image_popup_height', '500', 0),
(326, 0, 'theme_default', 'theme_default_image_popup_width', '500', 0),
(325, 0, 'theme_default', 'theme_default_image_thumb_height', '228', 0),
(324, 0, 'theme_default', 'theme_default_image_thumb_width', '228', 0),
(323, 0, 'theme_default', 'theme_default_image_category_height', '80', 0),
(322, 0, 'theme_default', 'theme_default_image_category_width', '80', 0),
(321, 0, 'theme_default', 'theme_default_product_description_length', '100', 0),
(320, 0, 'theme_default', 'theme_default_product_limit', '15', 0),
(319, 0, 'theme_default', 'theme_default_status', '1', 0),
(318, 0, 'theme_default', 'theme_default_directory', 'basecart', 0),
(659, 0, 'config', 'config_cart_weight', '1', 0),
(658, 0, 'config', 'config_invoice_prefix', 'INV-2013-00', 0),
(657, 0, 'config', 'config_account_mail', '0', 0),
(656, 0, 'config', 'config_account_id', '3', 0),
(654, 0, 'config', 'config_customer_price', '0', 0),
(655, 0, 'config', 'config_login_attempts', '5', 0),
(653, 0, 'config', 'config_customer_group_display', '["1"]', 1),
(652, 0, 'config', 'config_customer_group_id', '1', 0),
(651, 0, 'config', 'config_customer_online', '0', 0),
(649, 0, 'config', 'config_tax_default', 'shipping', 0),
(650, 0, 'config', 'config_tax_customer', 'shipping', 0),
(648, 0, 'config', 'config_tax', '1', 0),
(647, 0, 'config', 'config_voucher_max', '1000', 0),
(646, 0, 'config', 'config_voucher_min', '1', 0),
(645, 0, 'config', 'config_review_mail', '0', 0),
(643, 0, 'config', 'config_review_status', '1', 0),
(644, 0, 'config', 'config_review_guest', '1', 0),
(642, 0, 'config', 'config_limit_admin', '20', 0),
(640, 0, 'config', 'config_weight_class_id', '1', 0),
(339, 0, 'theme_default', 'theme_default_image_cart_height', '47', 0),
(340, 0, 'theme_default', 'theme_default_image_location_width', '268', 0),
(341, 0, 'theme_default', 'theme_default_image_location_height', '50', 0),
(641, 0, 'config', 'config_product_count', '1', 0),
(637, 0, 'config', 'config_currency', 'RUB', 0),
(639, 0, 'config', 'config_length_class_id', '1', 0),
(638, 0, 'config', 'config_currency_auto', '1', 0),
(636, 0, 'config', 'config_admin_language', 'ru-ru', 0),
(635, 0, 'config', 'config_language', 'ru-ru', 0),
(634, 0, 'config', 'config_zone_id', '3563', 0),
(633, 0, 'config', 'config_country_id', '222', 0),
(632, 0, 'config', 'config_comment', '', 0),
(631, 0, 'config', 'config_open', '', 0),
(630, 0, 'config', 'config_image', '', 0),
(629, 0, 'config', 'config_fax', '', 0),
(628, 0, 'config', 'config_telephone', '123456789', 0),
(627, 0, 'config', 'config_email', 'mashkovsky_ab@eniak.ru', 0),
(626, 0, 'config', 'config_geocode', '', 0),
(625, 0, 'config', 'config_address', 'Address 1', 0),
(624, 0, 'config', 'config_owner', 'AvtoBear', 0),
(623, 0, 'config', 'config_name', 'AvtoBear', 0),
(622, 0, 'config', 'config_layout_id', '4', 0),
(621, 0, 'config', 'config_theme', 'theme_default', 0),
(620, 0, 'config', 'config_meta_keyword', '', 0),
(619, 0, 'config', 'config_meta_description', 'My Store', 0),
(618, 0, 'config', 'config_meta_title', 'AvtoBear', 0),
(708, 0, 'config', 'config_error_log', '1', 0),
(709, 0, 'config', 'config_error_filename', 'error.log', 0);
...
--
-- Очистить таблицу перед добавлением данных `oc_upload`
--
...
(1, 1, 'admin', '08c93c38573d0456a7ce07c09272611ef052be2f', 'anjOzNrMQ', 'John', 'Doe', 'mashkovsky_ab@eniak.ru', '', '', '::1', 1, '2016-07-09 16:37:35');
