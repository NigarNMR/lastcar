ALTER TABLE  `TDM_PRICES` CHANGE  `SUPPLIER_OPTIONS`  `SUPPLIER_OPTIONS` VARCHAR( 1024 ) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ;
...
CREATE PROCEDURE pricesUpdate(IN inAKEY VARCHAR(64), IN inBKEY VARCHAR(64),
                              ...
                              IN inOptions VARCHAR(64), IN inSupplierOptions VARCHAR(1024),
